  ...
  return (
    <div className="min-h-screen px-4 py-6 md:px-8 lg:px-10">
      <div className="max-w-lg md:max-w-3xl lg:max-w-4xl mx-auto">
        <div className="mb-5">
          <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">Matches</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 animate-fade-in-up">
            ...
            <p className="text-neutral-600 dark:text-neutral-300 font-medium mb-1">No matches yet</p>
