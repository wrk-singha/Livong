    ...
    <div className="min-h-screen px-4 py-6 md:px-8">
      <div className="max-w-sm md:max-w-2xl lg:max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {message && (
            <span className="text-xs font-medium text-emerald-600 bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-full animate-fade-in-up">
              {message}
            </span>
          )}
        </div>
        ...
        <div className="card p-5 mb-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-semibold text-lg text-neutral-900">{profile.name}</h2>
          ...
          <div className="mt-4 flex items-center gap-2">
            <div className="flex-1 bg-neutral-50 rounded-lg px-3 py-2.5 text-center border border-neutral-100">
        ...
        <button
          onClick={logout}
          className="w-full mt-6 py-3 text-neutral-400 border border-neutral-200 rounded-lg text-sm font-medium hover:bg-red-50 hover:text-red-500 hover:border-red-200 transition-colors"
        >
          Logout
        </button>
      </div>
